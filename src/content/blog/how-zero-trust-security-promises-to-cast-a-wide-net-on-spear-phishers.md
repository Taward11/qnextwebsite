---
title: "How Zero Trust Security Casts a Wide Net on Spear-Phishers"
seoTitle: "How Zero Trust Security Casts a Wide Net on Spear-Phishers"
description: "Zero trust security is a fundamental security concept that introduces additional scrutiny around access to systems and data, not only from external factors but also internal ones. Given the increasing number of cyber-attacks exploiting internal controls and personnel of organizations worldwide, this security model is quickly gaining traction as the de-facto approach to protecting a company’s crown jewels against threats."
excerpt: "Zero trust security is a fundamental security concept that introduces additional scrutiny around access to systems and data, not only from external factors but also internal ones. Given the increasing number of cyber-attacks exploiting internal controls and personnel of organizations worldwide, this security model is quickly gaining traction as the de-facto approach to protecting a company’s crown jewels against threats."
date: 2021-08-12
modified: 2021-08-12
author: "Anthony DeCristofaro"
featuredImage: "/images/blog/how-zero-trust-security-promises-to-cast-a-wide-net-on-spear-phishers/SpearPhishing_CoverImage-e1666204181631.webp"
