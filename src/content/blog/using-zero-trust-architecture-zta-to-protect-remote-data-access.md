---
title: "Using Zero Trust Architecture (ZTA) to Protect Remote Data Access"
seoTitle: "Using Zero Trust Architecture (ZTA) to Protect Remote Data Access"
description: "Zero Trust Architecture (ZTA) is fast becoming the security model of choice as businesses worldwide recognize the need to better protect their networks and assets in light of today’s growing remote workforce."
excerpt: "Zero Trust Architecture (ZTA) is fast becoming the security model of choice as businesses worldwide recognize the need to better protect their networks and assets in light of today’s growing remote workforce."
date: 2021-05-31
modified: 2021-05-31
author: "Anthony DeCristofaro"
featuredImage: "/images/blog/using-zero-trust-architecture-zta-to-protect-remote-data-access/Zero-Trust-Architecture-ZTA-is-fast-becoming-the-security-model-of-choice-2-e1678995531324.webp"
...
According to [Gartner IT Research](https://www.gartner.com/teamsiteanalytics/servePDF?g=/imagesrv/media-products/pdf/Qi-An-Xin/Qi-An-Xin-1-1OKONUN2.pdf), “by 2022, 80% of new digital business applications opened up to ecosystem partners will be accessed through zero trust network access,” and 60% of enterprises will transition most of their remote access VPN solutions to ZTNA by 2023.  
...
![Types of Zero Trust Architectures zta](/images/blog/using-zero-trust-architecture-zta-to-protect-remote-data-access/EXTEND_ZT_GRAPHIC2.webp)
...
The ideal zero trust solution should be built from the ground up to apply Zero Trust Architecture (ZTA) to networks, applications, _and_ data. FileFlex Enterprise is the only data security solution of its kind and the most comprehensive platform for organizations that are ready to up-level their security around remote access to files and folders from the old-school perimeter-based model to zero trust.

### Remote work is here to stay.
Adversaries know this and they’re looking for ways to exploit any and all security vulnerabilities. Pivoting to a security infrastructure or enhancing your existing Zero Trust Architecture (ZTA) initiatives to facilitate fast, secure, and collaborative sharing is the smartest step you can take toward protecting your organization going forward. 
