...
modified: 2025-09-03
author: "Tom Ward"
featuredImage: "/images/blog/extending-cisco-zero-trust-from-access-to-data/Network-security-blog-cover-picture.webp"
featuredImageAlt: "Extending Cisco Zero Trust from Access to Data"
...
toc: true
faq:
  - q: "What is Cisco Zero Trust Data Access?"
    a: "Cisco Zero Trust Data Access ensures only verified users and compliant devices can access networks and applications with adaptive, continuous policies."
  - q: "Why is FileFlex needed with Cisco Zero Trust?"
    a: "FileFlex extends zero trust to the data layer, controlling file- and folder-level access and providing continuous monitoring and ransomware protection."
  - q: "How does FileFlex integrate with Cisco?"
    a: "FileFlex works alongside Duo, ISE, Secure Access, and Umbrella, bridging access control to secure data usage with auditing and anomaly detection."
  - q: "What types of data does FileFlex protect?"
    a: "FileFlex secures unstructured data across on-premises, cloud, hybrid, and multi-cloud storage, enforcing consistent zero trust policies."
tables:
  - id: "table1"
    headers:
      - "Cisco Zero Trust & Identity"
      - "FileFlex Zero Trust Data Access"
      - "Complementary Value"
    rows:
